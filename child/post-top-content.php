...
if ( et_has_post_format( 'quote' ) ) {
	...
	if ( get_post_thumbnail_id() ) {
        ...
        echo '<!--noindex-->';
        echo str_replace('<a', '<a rel="nofollow"', extra_get_the_post_featured_image( $args ));
//        extra_the_post_featured_image( $thumb_args );
        ...
        $thumb_args = !empty( $thumb_args ) ? $thumb_args : array();
        $r = preg_replace('/src=".*"/Ui', 'rel="nofollow" src="'.catch_that_image().'"', extra_get_the_post_featured_image( $args ));
//        extra_the_post_featured_image( $thumb_args );
        echo '<!--noindex-->';
        echo str_replace('</a>', '<span class="et_pb_extra_overlay"></span></a>', $r);
        echo '<!--/noindex-->';
        echo $score_bar;

//	    echo '<img src="'.catch_that_image().'"><span class="et_pb_extra_overlay"></span>';
    }
}
