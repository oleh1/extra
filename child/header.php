...
<head>
	...
	<script src="/wp-content/themes/child/scripts/scripts2.js" type="text/javascript"></script>
								...
								<?php if ( $header_vars['trending_posts']->have_posts() ) : ?>
									...
									?>
										<div id="et-trending-post-<?php the_ID(); ?>" class="<?php echo esc_attr( $trending_post_classes ); ?>">
											<a href="<?php if($url == get_permalink()){echo '#';} else {the_permalink();} ?>"><?php echo esc_html( truncate_title( 55 ) ); ?></a>
										</div>
									<?php
										$trending_post_count++;
									endwhile;
			...
			<div id="main-header-wrapper">
				<div id="main-header" data-fixed-height="<?php echo esc_attr( et_get_option( 'fixed_nav_height', '80' ) ); ?>">
					...
					<!-- ET Ad -->
						...
						if ( $show_logo && is_home() ) {
						?>

						<!-- Logo -->
						<a class="logo" data-fixed-height="<?php echo esc_attr( et_get_option( 'fixed_nav_logo_height', '51' ) ); ?>">
						...
						<!-- Logo with link -->
						<a class="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" data-fixed-height="<?php echo esc_attr( et_get_option( 'fixed_nav_logo_height', '51' ) ); ?>" style="width: 171px;height: 40px;">
							<img src="<?php echo esc_attr( $logo ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" />
						</a>
						...
						<div id="et-navigation" class="<?php echo $et_navigation_classes; ?>">
							...
							<?php
                                ...
                                $primary_nav = preg_replace('#<a href="http://avtozakony.smart-gooods.ru/">([^>]*)</a>#Ui', '<!--noindex--><a href="http://avtozakony.smart-gooods.ru/" rel="nofollow" target="_blank">$1</a><!--/noindex-->', $primary_nav);
								echo $primary_nav;
							}
							?>
